...
CREATE TABLE `mecanico` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKmecanico848266` (`id_cuenta`),
  CONSTRAINT `FKmecanico848266` FOREIGN KEY (`id_cuenta`) REFERENCES `cuenta` (`id_persona`)
...
INSERT INTO `mecanico` VALUES (1,5,'activo'),(2,11,'activo'),(3,12,'activo'),(4,13,'activo');
